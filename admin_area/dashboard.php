...
<div class="row"><!-- row no: 2 begin -->
            ...
            <div class="panel-heading"><!-- panel-heading begin -->
                <div class="row"><!-- panel-heading row begin -->
                    ...
                    <div class="col-xs-9 text-right"><!-- col-xs-9 text-right begin -->
                        <div class="huge"> <?php echo $count_items; ?>  </div>
    ...
    <div class="col-lg-3 col-md-6"><!-- col-lg-3 col-md-6 begin -->
        <div class="panel panel-green"><!-- panel panel-green begin -->
            ...
            <a href="index.php?view_bidders"><!-- a href begin -->
                <div class="panel-footer"><!-- panel-footer begin -->
        ...
        <div class="panel panel-red"><!-- panel panel-red begin -->
            ...
            <div class="panel-heading"><!-- panel-heading begin -->
                <div class="row"><!-- panel-heading row begin -->
                    ...
                    <div class="col-xs-9 text-right"><!-- col-xs-9 text-right begin -->
                        <div class="huge"> <?php echo $count_bids; ?> </div>
            ...
            <a href="index.php?view_bids"><!-- a href begin -->
                <div class="panel-footer"><!-- panel-footer begin -->
        ...
        <div class="panel panel-primary"><!-- panel panel-primary begin -->
            <div class="panel-heading"><!-- panel-heading begin -->
                <h3 class="panel-title"><!-- panel-title begin -->
                    ...
                    <i class="fa fa-money fa-fw"></i> New Bids
            ...
            <div class="panel-body"><!-- panel-body begin -->
                <div class="table-responsive"><!-- table-responsive begin -->
                    <table class="table table-hover table-striped table-bordered"><!-- table table-hover table-striped table-bordered begin -->
                        ...
                        <?php 
                                ...
                                $get_bids = "select * from user_bid order by 1 DESC LIMIT 0,5";
                                ...
                                while($row_bids=mysqli_fetch_array($run_bids)){
                                    ...
                                    $product_id = $row_bids['item_id'];
                                    
                                    $bid_date = $row_bids['bid_date'];
                ...
                <div class="text-right"><!-- text-right begin -->
                    ...
                    <a href="index.php?view_bids"><!-- a href begin -->
                        ...
                        View All Bids <i class="fa fa-arrow-circle-right"></i>
